...
7. Cada carta y el mazo tienen una sombra negra sutil e independiente; el turno activo tiene un contorno blanco separado de la carta y un halo rojo exterior.
...
- 2026-09-26 05:42 -06:00: Nueva corrección de PR #10: cada carta suma sombra negra sutil; el mazo tiene sombra por capas; el resalte del turno usa aro pseudo-elemento blanco de 2px con unos 3px de separación y halo rojo independiente de las sombras. Overflow visible deja salir el aro. Se renovaron las 10 capturas y se revisaron 3p/6p en escritorio/compacto. El layout de 6p compacto queda estrecho en las esquinas inferiores, con leve proximidad/solapamiento al asiento actual; no se alteraron tamaños ni posiciones en este ajuste.

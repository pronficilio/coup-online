...
La [issue #8 — referencias visuales para la partida](https://github.com/pronficilio/coup-online/issues/8) sigue abierta y asignada a `pronficilio`; su ejecución local está `BLOCKED` en F1 porque no hay un encoder cuya ejecución esté autorizada. Plan: `docs/plans/game-reference-materials/plan_game_reference_materials.md`; handoff: `docs/plans/blocked/issue_8_game_reference_materials.md`; bitácora: `docs/plans/log/issue-8.jsonl`.

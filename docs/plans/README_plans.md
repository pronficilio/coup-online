...
La [issue #8 — referencias visuales para la partida](https://github.com/pronficilio/coup-online/issues/8) sigue abierta y asignada a `pronficilio`; F1 está `CLOSED` con cuatro WebP optimizados. El [PR draft #12](https://github.com/pronficilio/coup-online/pull/12) contiene las vistas previas de F1; F2 sigue `PENDING` mientras se coordina el punto de montaje con #6. Plan: `docs/plans/game-reference-materials/plan_game_reference_materials.md`; handoff: `docs/plans/active/issue_8_game_reference_materials.md`; bitácora: `docs/plans/log/issue-8.jsonl`.
